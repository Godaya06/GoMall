...
import iphone17ProMaxImg from "@/assets/iphone17promax.png";
import iphone17ProImg from "@/assets/iphone17pro.png";
...
export const phones: Phone[] = [
  {
    ...
    storage: "1 TB",
    camera: "48 MP",
    display: "6.9\" Super Retina XDR ProMotion OLED",
    battery: "4832 mAh",
    chip: "A19 Pro",
    description: "The latest and greatest. iPhone 17 Pro Max introduces the A19 Pro chip, a redesigned pro camera system with 48MP triple lens, 8x optical zoom, and a sleek aerospace-grade titanium frame. Built for creators and power users.",
    colors: ["Deep Blue Titanium", "Natural Titanium", "White Titanium", "Black Titanium"],
  },
  {
    id: "iphone17pro",
    name: "iPhone 17 Pro",
    ...
    storage: "512 GB",
    camera: "48 MP",
    display: "6.3\" Super Retina XDR ProMotion OLED",
    battery: "3700 mAh",
    chip: "A19 Pro",
    description: "Pro power in a compact titanium body. iPhone 17 Pro brings the A19 Pro chip, an upgraded 48MP triple camera, and always-on ProMotion display with buttery-smooth 120Hz.",
    colors: ["Natural Titanium", "Deep Blue Titanium", "White Titanium", "Black Titanium"],
  },
  {
    id: "iphone17",
    name: "iPhone 17",
    ...
    battery: "3600 mAh",
    chip: "A19",
    description: "Everyday brilliance. iPhone 17 features the new A19 chip, a 48MP Fusion camera, Dynamic Island, and vibrant new colors — all in a lightweight aluminum body.",
    colors: ["Teal", "Sky Blue", "Coral", "White", "Black"],
  },
  {
    id: "iphone16promax",
  ...
  },
  {
    ...
    battery: "3279 mAh",
    chip: "A15 Bionic",
    description: "Certified refurbished iPhone 14. Fully tested, professionally restored, and backed by a 12-month warranty. Ships in premium GoMall packaging with a new battery and accessories.",
    colors: ["Midnight", "Starlight", "Blue", "Purple"],
  },
  {
    id: "iphone13-refurbished",
    ...
    battery: "3227 mAh",
    chip: "A15 Bionic",
    description: "Certified refurbished iPhone 13. Grade A condition, new battery, 12-month GoMall warranty. Great value with flagship performance.",
    colors: ["Midnight", "Starlight", "Blue", "Pink"],
  },
  {
    id: "iphone12-refurbished",
    ...
    battery: "2815 mAh",
    chip: "A14 Bionic",
    description: "Certified refurbished iPhone 12. Professionally restored, new battery, 12-month warranty. 5G-ready flagship at an unbeatable price.",
    colors: ["Blue", "Green", "White", "Black"],
  },
  {
    id: "iphone11-refurbished",
    ...
    battery: "3110 mAh",
    chip: "A13 Bionic",
    description: "Certified refurbished iPhone 11. Fully tested, new battery, GoMall 12-month warranty. Reliable everyday iPhone at a great value.",
